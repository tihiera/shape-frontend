...
const DEFAULT_MESH_COLOR: [number, number, number] = [200, 200, 210];
const HIGHLIGHT_COLOR: [number, number, number] = [255, 230, 80];

export interface MeshViewerHandle {
  zoomIn: () => void;
  zoomOut: () => void;
  resetCamera: () => void;
  toggleRotation: () => boolean; // returns new isRotating state
  isRotating: () => boolean;
}
